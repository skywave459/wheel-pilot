...
import 'create_account_driver_model.dart';
export 'create_account_driver_model.dart';

class CreateAccountDriverWidget extends StatefulWidget {
  const CreateAccountDriverWidget({
    super.key,
  ...
  @override
  State<CreateAccountDriverWidget> createState() =>
      _CreateAccountDriverWidgetState();
}

class _CreateAccountDriverWidgetState extends State<CreateAccountDriverWidget> {
  late CreateAccountDriverModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => CreateAccountDriverModel());
