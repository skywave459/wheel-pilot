...
import 'create_account_seeker_model.dart';
export 'create_account_seeker_model.dart';

class CreateAccountSeekerWidget extends StatefulWidget {
  const CreateAccountSeekerWidget({
    super.key,
  ...
  @override
  State<CreateAccountSeekerWidget> createState() =>
      _CreateAccountSeekerWidgetState();
}

class _CreateAccountSeekerWidgetState extends State<CreateAccountSeekerWidget> {
  late CreateAccountSeekerModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => CreateAccountSeekerModel());
